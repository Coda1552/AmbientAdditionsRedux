package codyhuh.ambientadditions.common.entities.util.ai.movement;
...
public class BottomFeederMoveControl extends MoveControl {
    private final AbstractFish entity;

    public BottomFeederMoveControl(AbstractFish entity) {
        super(entity);
        this.entity = entity;
    }
